...
var I18N = {
  ...
  'vi': {
    ...
    labelRename: 'Đổi tên nút (tùy chọn)', placeholderRename: 'vd: HK@HongKong|JP@Japan', btnAddUrl: 'Thêm đăng ký', labelUa: 'User-Agent tùy chỉnh (tùy chọn)', placeholderUa: 'Mặc định: clash-verge/<mới nhất>',
